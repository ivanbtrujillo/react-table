...
function leaves(root, childProperty) {
  if (Object.prototype.hasOwnProperty.call(root, childProperty)) {
    ...
    return (_ref = []).concat.apply(_ref, toConsumableArray(children));
  }
...
function iterTree(root, childProperty) {
  if (Object.prototype.hasOwnProperty.call(root, childProperty)) {
    ...
    return (_ref2 = []).concat.apply(_ref2, [root].concat(toConsumableArray(children)));
  }
...
function splitProps(_ref4) {
  var className = _ref4.className,
      style = _ref4.style,
      rest = objectWithoutProperties(_ref4, ['className', 'style']);
  ...
  return function (_Base) {
    ...
    createClass(_class, [{
      ...
      value: function getDataModel(newState, dataChanged) {
        ...
        var columnsWithExpander = hasSubComponentAndNoExpanderColumn ? [{ expander: true }].concat(toConsumableArray(columns)) : [].concat(toConsumableArray(columns));
        ...
        var addHeader = function addHeader(column) {
          ...
          if (column.columns) {
            ...
            level = Math.max.apply(Math, toConsumableArray(childLevels)) + 1;
          }
      ...
      value: function filterData(data, filtered, defaultFilterMethod, visibleColumns) {
        ...
        if (filtered.length) {
          ...
          filteredData = filteredData.map(function (row) {
            ...
            return _extends({}, row, defineProperty({}, _this3.props.subRowsKey, _this3.filterData(row[_this3.props.subRowsKey], filtered, defaultFilterMethod, visibleColumns)));
          }).filter(function (row) {
            if (!row[_this3.props.subRowsKey]) {
              return true;
            }
